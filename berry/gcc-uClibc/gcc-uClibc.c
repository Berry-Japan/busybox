...
/*	xstrcat(&(uClibc_inc[0]), devprefix, "/include/", NULL);
	...
	xstrcat(&(uClibc_inc[0]), UCLIBC_INC, "/", NULL);
	xstrcat(&(uClibc_inc[1]), UCLIBC_INC, "/", NULL);
...
/*	xstrcat(&(crt0_path[0]), devprefix, "/lib/crt1.o", NULL);
	...
	xstrcat(&(crt0_path[0]), UCLIBC_LIB, "/crt1.o", NULL);
	xstrcat(&(crt0_path[1]), UCLIBC_LIB, "/crt1.o", NULL);
	xstrcat(&(crti_path[0]), UCLIBC_LIB, "/crti.o", NULL);
	xstrcat(&(crti_path[1]), UCLIBC_LIB, "/crti.o", NULL);
	xstrcat(&(crtn_path[0]), UCLIBC_LIB, "/crtn.o", NULL);
	xstrcat(&(crtn_path[1]), UCLIBC_LIB, "/crtn.o", NULL);
